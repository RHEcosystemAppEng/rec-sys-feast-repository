...
if __name__ ==  '__main__':
    ...
    users.to_parquet('data/recommendation_users.parquet', index=False)
    items.to_parquet('data/recommendation_items.parquet', index=False)
    interactions.to_parquet('data/recommendation_interactions.parquet', index=False)
    interactions[['item_id', 'user_id']].to_parquet('data/interactions_item_user_ids.parquet', index=False)
    ...
    dummy_item_embed_df.to_parquet('data/dummy_item_embed.parquet', index=False)
    dummy_user_embed_df.to_parquet('data/dummy_user_embed.parquet', index=False)
    dummy_user_items_df.to_parquet('data/user_items.parquet', index=False)
